...
RSpec.describe 'API Update Client Belonging To A Specific Product', type: :request do
  ...
  context 'PUT /api/v1/products/:product_id/clients/:id' do
    it 'updates a specific client belonging to a specific product' do
      put api_v1_product_client_path(product_id: @product.id, id: @client.id), { client: client_attributes }, headers
    ...
    it 'updates a specific client belonging to a specific product with nested products' do
